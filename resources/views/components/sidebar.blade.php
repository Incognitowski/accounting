<div class="flex flex-no-grow overflow-hidden shadow-lg border-t-4 bg-white mb-4 rounded-b-lg rounded-t border-grey-light md:min-w-1/6">
  <div class="px-6 py-4 mb-2 mt-4 mb-8 flex flex-col flex-no-shrink w-auto">
    <!-- SECTION 0 -->
    <div class="flex w-auto cursor-pointer border px-4 py-2 text-lg text-grey-darkest" style="border-left: 4px solid #dae1e7 !important;">
      <div class="pl-2"><a class='no-underline text-grey-darkest' href="{{ url('/') }}">Página Principal</a></div>
    </div>
    <!-- SECTION 1 -->
    <div class="uppercase tracking-wide text-c2 mb-4 mt-8">Receitas</div>
    <div class="flex w-auto cursor-pointer border px-4 py-2 text-lg text-grey-darkest" style="border-left: 4px solid #51d88a !important;">
