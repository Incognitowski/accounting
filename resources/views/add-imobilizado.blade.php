        ...
        <form id='imobilizadoForm' action="{{ url('/imobilizado/add') }}" method="POST">
          ...
          <div class="-mx-3 md:flex mb-6 pb-6 border-b border-grey">
            ...
            <div class="md:w-1/2 px-3">
              ...
              <input name='vidaUtil' min="1" id='vidaUtil' required type='number' step='1' class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4">
            </div>
            <div class="md:w-1/2 px-3">
              <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" for="grid-last-name">
