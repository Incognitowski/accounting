        ...
        <form id='imobilizadoForm' action="{{ url('/imobilizado/add') }}" method="POST">
          ...
          <div class="-mx-3 md:flex mb-6">
            <div class="md:w-1/2 px-3">
              ...
              <input name='descricao' value="{{ $imobilizadoAtual->imob_descricao }}" required class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="grid-last-name" type="text" placeholder="Doe">
            </div>
            <div class="md:w-1/2 px-3">
              <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" for="grid-last-name">
                Data de Aquisição
              </label>
              <input type='date' value="{{ $imobilizadoAtual->imob_aquisicao }}" name='dataAquisicao' required class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4">
            </div>
            <div class="md:w-1/2 px-3">
              <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" for="grid-last-name">
                Valor
              </label>
              <input type='number' name='valor' value="{{ $imobilizadoAtual->imob_valor }}" required step='0.01' class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4">
            </div>
          </div>
          ...
          <div class="-mx-3 md:flex mb-6 pb-6 border-b border-grey">
            <div class="md:w-1/2 px-3">
              ...
              <div class="relative">
                ...
                <select name='isDepreciavel' id='depreciabilidadeSelect' required class="block appearance-none w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded" id="grid-state">
                  ...
                  <option value='false' {{ $ndepreciavel }}>Não Depreciável</option>
                </select>
            ...
            <div class="md:w-1/2 px-3">
              ...
              <input type='text' id='taxaDepreciacao' value="{{ $depreciacao }}% ao Ano" readonly class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4">
            </div>
          </div>
